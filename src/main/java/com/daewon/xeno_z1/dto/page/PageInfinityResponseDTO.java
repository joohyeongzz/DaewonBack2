...
@Getter
@ToString
public class PageInfinityResponseDTO<E> {
    ...
    public PageInfinityResponseDTO(PageRequestDTO pageRequestDTO, List<E> dtoList, int totalIndex) {
        if (totalIndex <= 0) {
            return;
        }
        ...
        this.next = totalPageIndex > this.pageIndex;
    }
}